...
public class BookRepositoryCustomTest {
    ...
    public void shouldHaveCorrectDeleteBookAndComments() {
        ...
        assertAll(() -> assertEquals(Optional.empty(), commentRepositoryJpa.getById(3L)),
                () -> assertEquals(Optional.empty(), commentRepositoryJpa.getById(2L)),
                () -> assertEquals(Optional.empty(), bookRepositoryJpa.getById(2L)));
    }
